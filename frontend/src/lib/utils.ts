...
const ERRORS: Record<string, string> = {
  ...
  NOTIFICATION_STATUS_INVALID: 'O estado das notificações não é válido.',
  NOTIFICATION_CHANNEL_INVALID: 'O canal de notificações não é válido.',
  NOTIFICATION_NOT_PROCESSING: 'Esta notificação já não está disponível para processamento.',
  WHATSAPP_PROVIDER_NOT_CONFIGURED: 'O envio por WhatsApp ainda não está configurado.',
  EMAIL_PROVIDER_NOT_CONFIGURED: 'O envio por email ainda não está configurado.',
  ...
  PAYMENT_REQUEST_INVALID: 'Os dados do pagamento não são válidos. Tenta de novo.',
  PAYMENT_PROVIDER_DISABLED: 'Este método de pagamento não está disponível nesta barbearia.',
  PAYMENT_PROVIDER_NOT_CONFIGURED: 'Este método de pagamento ainda não está configurado pela barbearia.',
  PAYMENT_ALREADY_PAID: 'Este sinal já foi pago.',
  PAYMENT_NOT_REQUIRED: 'Esta marcação já não precisa de pagamento.',
  PAYMENT_IDEMPOTENCY_CONFLICT: 'O pagamento anterior não pôde ser recuperado. Inicia uma nova tentativa.',
  PAYMENT_METRICS_EMPTY_RESPONSE: 'Não foi possível carregar os indicadores de pagamentos.',
  PAYMENT_STATUS_UNAVAILABLE: 'Não foi possível consultar o estado do pagamento.',
  PAYMENT_RECONCILIATION_UNAVAILABLE: 'O pagamento está a ser reconciliado. Tenta novamente dentro de instantes.',
  PAYMENT_FINALIZATION_FAILED: 'O pagamento foi recebido, mas a confirmação ainda está a ser processada.',
  PAYMENT_PROVIDER_REQUEST_FAILED: 'Não foi possível comunicar com o provider. Tenta novamente.',
  MPESA_CONFIG_INCOMPLETE: 'A configuração do M-Pesa está incompleta.',
  MPESA_CREDENTIALS_INCOMPLETE: 'As credenciais do M-Pesa estão incompletas.',
  EMOLA_CONFIG_INCOMPLETE: 'A configuração do e-Mola está incompleta.',
  EMOLA_CREDENTIALS_INCOMPLETE: 'As credenciais do e-Mola estão incompletas.',
  EMOLA_PHONE_INVALID: 'Para e-Mola, usa um número Movitel 86 ou 87.',
  PAYMENT_CREDENTIALS_REQUIRED: 'Guarda as credenciais do provider antes de o activar.',
  PAYMENT_STATE_INVALID: 'O estado do pagamento não é válido.',
  PAYMENT_INVALID_TRANSITION: 'Essa alteração de estado do pagamento não é permitida.',
  PAYMENT_NOT_FOUND: 'Pagamento não encontrado.',
  PAYMENT_EMPTY_RESPONSE: 'O pagamento não devolveu um resultado válido.',
  ...
  REVIEW_RATING_INVALID: 'A avaliação precisa de ter entre 1 e 5 estrelas.',
  REVIEW_COMMENT_TOO_LONG: 'O comentário pode ter no máximo 2000 caracteres.',
  REVIEW_APPOINTMENT_NOT_COMPLETED: 'A avaliação só fica disponível depois de concluir a visita.',
  REVIEW_NOT_AVAILABLE_YET: 'A avaliação só fica disponível uma hora depois da visita.',
  ...
  PLAN_NOT_ACTIVE: 'Este plano não está activo.',
  PLAN_BARBER_LIMIT_TOO_LOW: 'O plano seleccionado não suporta o número actual de barbeiros activos.',
  PLAN_IN_USE: 'Este plano ainda está atribuído a barbearias e não pode ser desactivado.',
  PLAN_NOT_FOUND: 'O plano não foi encontrado.',
  INVALID_PLAN_NAME: 'O nome do plano não é válido.',
  INVALID_PLAN_PRICE: 'O preço do plano não é válido.',
  INVALID_MAX_BARBERS: 'O limite de barbeiros não é válido.',
