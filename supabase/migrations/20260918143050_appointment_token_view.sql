...
returns table(
  ...
  appointment_status public.appointment_status, deposit_status public.deposit_state,
  deposit_cents int, service_name text, service_price_cents int, service_duration_min int,
  haircut_name text, barber_name text, barber_photo_url text, can_cancel boolean,
  can_reschedule boolean, action_deadline timestamptz
)
